...
class TWOACTSOBSTACLE_STATE : public STATE
{
    public:
...
class TWOACTSOBSTACLE : public SIMULATOR
{
    public:

        TWOACTSOBSTACLE(std::vector<std::vector<double>> map,
    ...
    private:
        mutable MEMORY_POOL<TWOACTSOBSTACLE_STATE> MemoryPool;
